...
import TextInput from "../Input/TextInputt";
    ...
    return (
        ...
        >
            ...
            <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
                ...
                />
                {/* ✅ Fixed: unique position, no duplicate classes */}
                <div
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                                ...
                                {SOCIAL_LINKS.map((social) => (
                                    <motion.a
                                        ...
                                        className={`flex items-center space-x-3 p-4 rounded-xl border transition-all duration-300 ${isDarkMode
                                            ? "bg-gray-800/50 border-gray-700 hover:border-gray-60"
                        ...
                        <motion.div
                            variants={itemVariants}
                            className={`p-6 rounded-xl border mt-4 ${isDarkMode
                        ...
                        >
                            ...
                            >
                                I'm currently available for freelance projects and full-time opportunites
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
                    ...
                    >
                        ...
                        >
                            <a
                                ...
                                className={`px-6 py-3 rounded-full border font-medium transition-all duration-300 inline-block ${isDarkMode
