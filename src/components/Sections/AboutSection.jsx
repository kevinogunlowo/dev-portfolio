                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                I'm a software engineer based in Scarborough, Ontario, with hands-on
                                experience building cross-platform mobile and web applications. I've worked
                                professionally with Flutter and Dart at WIMTACH (Centennial College) and
                                WOCA Tech Solutions, shipping real apps used by real people — and I care
                                deeply about writing clean, scalable code that follows SOLID principles and
                            ...
                            >
                                My stack spans Flutter, React, JavaScript, TypeScript, Python and more,
                                backed by Microsoft certifications in Azure, AI, Data, Security and Power
                                Platform. I hold an Advanced Diploma in Software Engineering Technology
                                from Centennial College and a BSc in Computer and Mathematical Sciences
                                from Crawford University. When I'm not building, I'm learning — because
                                in this field, standing still means falling behind.
                            </p>
                        </motion.div>
                        ...
                        <motion.div variants={itemVariants} className="text-center py-8">
                            ...
                            <div className="flex justify-center">
                                <img src={SIGNATURE} alt="KEVIN" className="w-28" />
                            </div>
                            <div className="text-lg font-medium text-blue-500 mt-2">Ogunlowo Kevin</div>
                        </motion.div>
                    </motion.div>
                            ...
                            {JOURNEY_STEPS.map((step) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`text-sm leading-relaxed ${isDarkMode ? "text-blue-400" : "text-blue-600"
                                                } mb-3`}
                                        >
                                            {step.company}
                                        </div>
